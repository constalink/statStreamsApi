/**
 * LessThan
 * Compares two numbers and tells if value1 is less than value2
 *
 ...
 *
 * If value1 is less than value2 then 1 is returned
 ...
 * @return       1 if value1 is less than value2, 0 if not
...
#ifndef LessThan_Header_DEF
#define LessThan_Header_DEF
...
// Header definition
//-------------------------------------------------------------------------------------
int8_t LessThan(typeValueRef* value1, typeValueRef* value2);
