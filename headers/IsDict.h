/**
 * IsDict
 * Tells whether or not a value is a dictionary
 * This function simply checks the flags property to see if the DICT flag is set.
 * See typeDict.h - that's where the DICT flag is defined
 * The DICT flag is usually only set by the Dict function... the function that's
 * responsible for creating dictionary values.
 *
...
#ifndef IsDict_Header_DEF
#define IsDict_Header_DEF
