 ...
 * Compares two numbers and tells if value1 is greater than or equal to value2
 *
 ...
 *
 * If value1 is greater than or equal to value2 then 1 is returned
 * If value1 is less than value2, then 0 is returned
 *
 * @param value1 A pointer to the first number to compare
 * @param value2 A pointer to the second number to compare
 * @return       1 if value1 is greater than or equal to value2, 0 if not
...
#ifndef GreaterThanOrEqualTo_Header_DEF
#define GreaterThanOrEqualTo_Header_DEF
...
// Header definition
//-------------------------------------------------------------------------------------
int8_t GreaterThanOrEqualTo(typeValueRef* value1, typeValueRef* value2);
