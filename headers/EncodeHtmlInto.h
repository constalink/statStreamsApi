 ...
 * the encoded data. Checkout the EncodeHtmlLength function to get the byte length
 * necessary to hold an HTML encoded value.
 *
 * This is a lower level version of the EncodeHtml function. In fact, the EncodeHtml
...
#ifndef EncodeHtmlInto_Header_DEF
#define EncodeHtmlInto_Header_DEF
...
// Header definition
//-------------------------------------------------------------------------------------
intmax_t EncodeHtmlInto(uint8_t* text, intmax_t textLen, uint8_t* encoded);
