/**
 * BoolFalse
 * Returns the "false" value reference. The return value is a global
 ...
 * enValueRefTypeBool
 *
 * @return A pointer to the "false" value reference
 *
 * @license  	MIT
...
#ifndef BoolFalse_Header_DEF
#define BoolFalse_Header_DEF
