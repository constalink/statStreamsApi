/**
 * BitwiseXorInPlace
 * Calculates a bitwise XOR operation in place
 *
 ...
 * @param xOrWords A pointer to a 64 bit word array to XOR intWords with
 * @param xOrLen   The number of 64 bit words in the xOrWords array
 *
 * @license  	MIT
...
#ifndef BitwiseXorInPlace_Header_DEF
#define BitwiseXorInPlace_Header_DEF
