/**
 * JsonToBool
 * Converts a JSON string to a boolean value
 *
 * This function takes a json encoded string and an offset to start
 * decoding the boolean value at and returns a result that either
 ...
 *
 * The json string is expected to have either a 't' or an 'f' character at the offset
...
#ifndef JsonToBool_Header_DEF
#define JsonToBool_Header_DEF
...
// Header definition
//-------------------------------------------------------------------------------------
typeJsonToItemResult* JsonToBool(typeData* json, intmax_t offset);
