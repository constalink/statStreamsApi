/**
 * TrimStartChars
 * Trims characters from the start of a typeData value
 ...
 * @return           A pointer to a new typeData value that has the characters removed from the start
 *
 * @license  	MIT
...
#ifndef TrimStartChars_Header_DEF
#define TrimStartChars_Header_DEF
...
// Header definition
//-------------------------------------------------------------------------------------
typeData* TrimStartChars(typeData* data, typeData* characters);
