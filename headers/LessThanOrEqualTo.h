/**
 * LessThanOrEqualTo
 * Compares two numbers and tells if value1 is less than or equal to value2
 *
 ...
 *
 * If value1 is less than or equal to value2 then 1 is returned
 ...
 * @return       1 if value1 is less than or equal to value2, 0 if not
...
#ifndef LessThanOrEqualTo_Header_DEF
#define LessThanOrEqualTo_Header_DEF
...
// Header definition
//-------------------------------------------------------------------------------------
int8_t LessThanOrEqualTo(typeValueRef* value1, typeValueRef* value2);
