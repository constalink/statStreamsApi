/**
 * JsonToDict
 * Converts a JSON string into a dictionary value
 *
 * This function takes a json encoded string and an offset to start
 * decoding the dictionary value at and returns a result that either
 ...
 *
 * The json string is expected to have a curly brace character '{' at the offset
...
#ifndef JsonToDict_Header_DEF
#define JsonToDict_Header_DEF
...
// Header definition
//-------------------------------------------------------------------------------------
typeJsonToItemResult* JsonToDict(typeData* json, intmax_t offset);
