/**
 * AnyType
 * Returns the "any" or the "any?" typeType value. The return value is a global
 ...
 * @return         A pointer to the "any" or "any?" typeType value
 *
 * @license  	MIT
...
// Header definition
//-------------------------------------------------------------------------------------
typeType* AnyType(typeBool optional);
