/**
 * NotEquals
 * Compares two values and tells whether or not they are NOT equal
 *
 ...
 * @return       true if the two values are NOT considered equal or false otherwise
 *
 * @license  	MIT
...
#ifndef NotEquals_Header_DEF
#define NotEquals_Header_DEF
...
// Header definition
//-------------------------------------------------------------------------------------
typeBool NotEquals(typeValueRef* value1, typeValueRef* value2);
